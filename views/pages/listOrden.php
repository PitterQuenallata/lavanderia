                                ...
                                if (!empty($ordenes)) {
                                    foreach ($ordenes as $key => $orden) {
                                        ...
                                        switch ($orden["estado_orden"]) {
                                            case 0:
                                                $estadoOrden = '<span class="badge bg-primary">Recibido</span>';
                                                break;
                                            case 1:
                                                $estadoOrden = '<span class="badge bg-info">Listo para entrega</span>';
                                                break;
                                            case 2:
                                        ...
                                        echo '
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <button 
                                                            class="btn btn-primary btn-sm btnImprimirOrden" 
                                                        ...
                                                        // Mostrar botón de verificar pago si aplica
                                                        if ($orden["id_metodo_pago"] == 1 && $orden["estado_pago"] == "Pendiente") {
                                                            echo '<button 
                                                                    class="btn btn-success btn-sm btnVerificarPago" 
                                                                    data-movimiento-id="' . $orden["movimiento_id"] . '" 
                                                                    data-id-orden="' . $orden["id_orden"] . '">Verificar Pago</button>';
                                                        }
